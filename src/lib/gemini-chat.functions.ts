...
export const chatWithGemini = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    // تم وضع مفتاحك المجاني هنا بشكل آمن داخل دالة السيرفر لضمان عدم وصول المتصفح إليه
    const apiKey = "AQ.Ab8RN6LUh7esLI6oz3NPyj1TVanZhP99_1ZEHrMJc_awMLm1jw";

    // استخدام النموذج المجاني والمستقر بالكامل
